        ...
        <div class="main-dashboard-content">
            ...
            <div class="dashboard-grid">
                <a href="{{ route('resepsionis.pendaftaran') }}" class="dashboard-card">
                    <h3><i class="fas fa-calendar-check"></i> Registrasi Pasien</h3>
                    <p>Lihat dan kelola janji temu pasien.</p>
                </a>
                <!-- Anda bisa menambahkan card lain di sini jika ada menu tambahan -->
            </div>
